		...
		return(
			  <div className="card-body text-center">
			  	...
			  	<div className="row">
			  		...
			  		<div className="col-lg-12">
			  			<div className="profile" style={{maxWidth: '324px'}}>
				  			<div className="row">
				  			...
				  			<div className="row">
				  					<div className="col-lg-12">
				  						<br/>
				  						<br/>
				  						{ role=="faculty" ? <button  className="btn btn-md bg-red b-round" type="button" onClick={this.singOut}> Sign Out </button> : null}
				  					</div>
				  			</div>
				  		</div>
			  		</div>
