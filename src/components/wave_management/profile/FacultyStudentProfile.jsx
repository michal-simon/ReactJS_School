...
class FacultyStudentProfile extends React.Component{
	...
	handleChangeLocation(event){
		...
		firebase.update("students/"+params.id_student,{current_location:location[0],currentLocation_type:ch })
	}
	...
	renderSelect(txt,options,name,key_value,k){
		...
		return <select key={k} value={this.state[name]} className={"form-control theselect f-s bg-principal "} name={name} onChange={(e)=>this.handleChangeLocation(e)} required >
		  			...
		  			<div className="profile">
			  			<div className="row">
			  				<div className="col-lg-12 text-center">
			  					<span style={{maeginLeft:'5px'}} className="profile-details fname">{student.first_name + " " + student.last_name }</span>
			  				</div>
			  			</div>
			  			<div className="row">
			  				<div className="col-lg-12">
								  	<div className="form-group">
								   		...
								   		<button class="btn btn-md float-right bg-inverse-principal b-round bb" type="button">
								            <span> 
								            	 <small className={showl(student.currentLocation_type)}></small>
								            	 { " " + student.current_location? " " + student.current_location :""}
								            </span>
								   		</button>
			  			...
			  			<div className="row">
			  				<div className="col-lg-4">
			  					<span className="profile-details">Grade:</span>
			  				</div>
			  				<div className="col-lg-8">
			  					<span className="profile-details-item">{student.grade+"th Grade"}</span>
			  				</div>
			  			</div>
			  		</div>
		  		</div>
